      ...
      >
        <div className="relative z-10 max-w-2xl px-4">
          ...
          <p className="text-lg md:text-xl mb-3">
            We care to cure – A platform created by passionate Engineering IT
            students, dedicated to helping India in various domains through our
            CareKaro services.
          </p>
      ...
      <div className="bg-gradient-to-b from-transparent to-blue-900 text-black">
        <section className="text-center py-12 px-4 max-w-3xl mx-auto">
          ...
          <p className="text-black">
            CareKaro was created with a vision to provide an all-in-one digital
            healthcare platform that bridges key gaps in India’s medical
            ecosystem. It features an AI-powered health assistant that analyzes
            your symptoms and offers instant guidance, along with multilingual
            report analysis so users can understand their medical data in their
            preferred language. Our smart services include medicine delivery by
            searching across multiple platforms, real-time ambulance tracking
            with traffic insights for faster routes, and urgent care support. We
            also provide an interactive map to locate nearby hospitals with
            detailed specifications and deliver dynamic health updates, ensuring
            people stay informed about vital news and ongoing trends in the
            healthcare space.
          </p>
        </section>
        ...
        <section className="text-center pt-6 pb-10 px-4 max-w-4xl mx-auto">
          ...
          <p className="text-black">
            ...
            With expertise in Web 2.0 and Web 3.0 technologies, our mission is
            to leverage our skills to build impactful solutions that contribute
            to a healthier future for India.
          </p>
          <p className="text-black mb-4">
            We are a team of passionate student developers dedicated to
        ...
        <header className="text-center py-10">
          <span className="uppercase text-black tracking-wider">
            CareKaro Developers
          </span>
        ...
        <footer className="text-center py-4 bg-blue-900">
          <p>
            © {new Date().getFullYear()} All Rights Reserved | Team Name
            Webugbusters
          </p>
        </footer>
      </div>
